...
class TestObjectIdentifier(TestCase):
    ...
    def test_dotted_string(self):
        ...
        self.assertTrue(
            ObjectIdentifier._is_dotted_string(good_dotted_string),
            "Correct dotted string should pass",
        )
        self.assertFalse(
            ObjectIdentifier._is_dotted_string(not_dotted_string),
    ...
    def test_reverse_lookup(self):
        ...
        self.assertIsNotNone(
            ObjectIdentifier._reverse_lookup(good_name),
            "Correct name lookups should pass",
        )
        self.assertIsNone(
            ObjectIdentifier._reverse_lookup(bad_name), "Bad name lookups should fail"
        )
